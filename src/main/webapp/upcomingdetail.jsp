...
String Dql = "select * from vehicleshowroom.upcomingcar Where Cid=?";
...
try {
    ...
    if(rs.next())
    {
    	...
    	out.println("<html>" 
				+ "<body bgcolor = 'Orange'>" +"<div class='c1'><div class='d1'>Upcoming car Details: </div><br>  <div class='d1'>Car Id: "+id1+ "</div>"
				+"<div class='d1'>Car Name: "+name + "</div><div class='d1'>Car Model: "+ model
				+ "</div><div class='d1'>Car price:"+ price +" Rs</div><br><br>"
				+ "<div class='d1 d2'>Booking Successfull!!!</div></div>"+"</body></html>");
    }
  
    else{
    	
    	out.println("<html>" 
				+ "<body bgcolor = 'Orange'>" +"<div class='c2'><div class='d1'>Upcoming car Details: </div><br><div class='d1'>Car Id: Id "+id+ " is invalid details</div>"+"<br></body></html>" );
    }
