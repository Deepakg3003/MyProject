...
String qry = "select * from vehicleshowroom.upcomingcar";
...
while(rs.next())
{
	...
	out.println("<html>" 
			+ "<body class='b1' bgcolor = 'Orange'><table class='tab' bgcolor = 'white' border='5px' rules='all' align='center' cellspacing='10px' cellpadding='10px'>"
        +"<tr><th>Car ID</th><th>Car Name</th><th> Model</th> <th>Price</th></tr>"+ 
	"<tr><td>"+ id + "</td> <td>"+ name + "</td><td>" + model + "</td><td>" + price +
...
<form class="fm" action="upcomingdetail.jsp">
<div class="div1">
